...
type DurationCallbacks struct {
	vector *prometheus.SummaryVec
}

func NewDurationCallbacks(opts prometheus.SummaryOpts) *DurationCallbacks {
...
func (c *DurationCallbacks) Name() string {
	return "prometheus"
}

func (c *DurationCallbacks) Initialize(db *gorm.DB) error {
...
func (c *DurationCallbacks) Before() func(db *gorm.DB) {
...
func (c *DurationCallbacks) After(typ string) func(db *gorm.DB) {
	return func(db *gorm.DB) {
